...
using static P02_FootballBetting.Common.ApplicationConstants;


namespace P02_FootballBetting.Data;

public /* sealed (Judje may have problems with sealed classes) */ class FootballBettingContext : DbContext
{
